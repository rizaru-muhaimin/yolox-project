...
Usage: python scripts/prepare_workshop.py "Workshop tools 3.v2i.coco.zip" --output datasets/workshop_tools
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output', type=Path, default=Path(__file__).resolve().parents[1] / 'datasets' / 'workshop_tools')
